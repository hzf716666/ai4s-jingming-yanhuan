...
import { seriesColor, CHART_PALETTE_LIGHT, CHART_PALETTE_DARK } from "@jingming/shared";

// The palette is the single source of truth shared with index.css --series-*
// and runtime/.../jingming-yanhuan.mplstyle. Lock the hexes so those three stay in sync.
