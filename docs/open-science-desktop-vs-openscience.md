# 景明研环 vs OpenScience: two open-source Claude Science alternatives

景明研环 and Synthetic Sciences OpenScience are both open-source
...
- **Choose 景明研环** if you want a local-first desktop app for macOS,
...
| Dimension | 景明研环 | Synthetic Sciences OpenScience |
| --- | --- | --- |
...
surface: 景明研环 emphasizes a desktop, local-first workflow; Synthetic
Sciences OpenScience emphasizes a browser workspace and CLI-driven research loop.

## Sources

- 景明研环 GitHub: <https://github.com/ai4s-research/open-science>
