...
name: 文献检索方法
type: knowledge
description: 系统文献检索方法：检索策略、数据库选择、筛选与证据综合
version: "1.0"
category: experiment
applicable_stages: [3, 4, 5, 6]
priority: 2
trigger_keywords: ['literature', 'review', 'systematic', 'PRISMA', 'search', 'database']
author: 自主科研流水线
source: arc
---
...
3. Specify publication types (同行评审ed, preprints, conference papers)
