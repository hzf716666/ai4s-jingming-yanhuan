---
name: literature-collect
type: executor
description: 多源文献检索与收集：OpenAlex/Semantic Scholar/arXiv，去重并生成语料库
version: "1.0.0"
phase: literature
stage: 4
inputs: []
outputs: ['corpus.csv', 'search_log.md']
dependencies: []
natural_next: ['literature-screen']
gate: false
idempotent: false
reentrant_strategy: new_run
entry_points: ['have_questions', 'literature_only']
...
> 来源: AutoResearchClaw Stage 4 | Phase: literature

## 职责边界

- ✅ 多源文献检索与收集：OpenAlex/Semantic Scholar/arXiv，去重并生成语料库
- ❌ 不处理上下游 skill 的职责
