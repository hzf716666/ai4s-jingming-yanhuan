---
name: 领域正确性检查
description: 运行科研分析代码前后执行领域正确性检查：单位/量纲、坐标系、索引、统计多重比较等典型科学错误
---
...
```bash
python "$XDG_CONFIG_HOME/opencode/skills/领域正确性检查/domain_check.py" <file.py|notebook.ipynb|analysis.R ...>
```
